<#
.SYNOPSIS
    Popup de notificacao de aniversario, estilo toast, para celebrar colaboradores.

.DESCRIPTION
    - Anima deslizando de baixo para cima ao aparecer
    - Sem acao de clique (nao abre link) - e so uma mensagem de celebracao
    - Botao "X" no canto: fecha o popup
    - Auto-close por timer
...
# ====================== CONFIGURACAO ======================
$Linha1         = "Hoje é dia de celebrar você!"
